	...
	**/
	...
	public static function loadColorz(?palette1:String, ?palette2:String) {
		...
		for (pal in [palette1, palette2]) {
			...
			colorzShaders.push(new Colorz(Std.parseInt("0x" + json.left.inner), Std.parseInt("0x" + json.left.outer), Std.parseInt("0x" + json.left.base)));
			colorzShaders.push(new Colorz(Std.parseInt("0x" + json.down.inner), Std.parseInt("0x" + json.down.outer), Std.parseInt("0x" + json.down.base)));
			colorzShaders.push(new Colorz(Std.parseInt("0x" + json.up.inner), Std.parseInt("0x" + json.up.outer), Std.parseInt("0x" + json.up.base)));
			colorzShaders.push(new Colorz(Std.parseInt("0x" + json.right.inner), Std.parseInt("0x" + json.right.outer), Std.parseInt("0x" + json.right.base)));
